...
walkGridIterations 100 exampleGrid (500,500) Up 0
    |> printfn "Example after 100 iterations: grid: %A %A" exampleGrid

let challengeInput = (System.IO.File.ReadAllText("inputChallenge22.txt"))
let challengeAGrid = newGrid challengeInput 1001 

let challengeB = walkGridIterations 10000000 challengeAGrid (500,500) Up 0
challengeB |> printfn "Challenge after 10000000 iterations: %A" 
